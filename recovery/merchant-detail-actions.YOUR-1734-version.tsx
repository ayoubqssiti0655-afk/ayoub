...
import {
  setMerchantStatusAction, updateMerchantConfigAction, createSettlementForMerchantAction,
} from "@/server/admin-actions";
import { Power, Banknote, Settings2 } from "lucide-react";

export function MerchantAdminActions({ id, status, settlementCycle, plan, wallet }: {
  id: string; status: string; settlementCycle: string; plan: string; wallet: number;
}) {
